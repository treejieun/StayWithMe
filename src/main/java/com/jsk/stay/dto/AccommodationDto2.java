...
public class AccommodationDto2 {
	...
	public AccommodationDto2() {
		super();
	}
	
	public AccommodationDto2(String mb_id, int acm_code, int acm_charge, String acm_availdate, String acm_checkin_time,
			String acm_checkout_time, String acm_type, String acm_room_type, int acm_guest_num, int acm_room_num,
			int acm_bath_num, int acm_area, String acm_bedding, String acm_address, String acm_add_detail, int acm_zip,
			String acm_title, String acm_thumbnail) {
		super();
		this.mb_id = mb_id;
